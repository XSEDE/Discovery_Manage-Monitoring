...
### BEGIN INIT INFO
# Provides:          route_monitoring
# Required-Start:    $remote_fs $syslog
# Required-Stop:     $remote_fs $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Route Monitoring messages from a source to a destination
# Description:       Route Monitoring messages from a {file, directory, amqp} to a {directory, api}
### END INIT INFO

####### Customizations START #######
APP_NAME=route_monitoring
APP_BASE=/soft/warehouse-apps-1.0/Manage-Monitoring
...
APP_OPTS="-l info --expire -c ${APP_BASE}/conf/${APP_NAME}.conf"
